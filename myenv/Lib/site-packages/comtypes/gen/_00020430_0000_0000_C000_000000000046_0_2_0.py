...
__all__ = [ 'OLE_YPOS_HIMETRIC', 'FONTUNDERSCORE',
           'FONTSTRIKETHROUGH', 'Picture', 'OLE_YSIZE_HIMETRIC',
           'IFont', 'OLE_YSIZE_PIXELS', 'Monochrome', 'OLE_HANDLE',
           'FontEvents', 'OLE_YPOS_PIXELS', 'FONTBOLD',
           'OLE_OPTEXCLUSIVE', 'Unchecked', 'FONTNAME',
           'OLE_XPOS_PIXELS', 'OLE_XPOS_HIMETRIC', 'FONTITALIC',
           'StdPicture', 'OLE_COLOR', 'OLE_XSIZE_HIMETRIC',
           'OLE_YPOS_CONTAINER', 'OLE_XSIZE_CONTAINER',
           'IPictureDisp', 'Default', 'OLE_XSIZE_PIXELS', 'Font',
           'OLE_CANCELBOOL', 'IFontDisp', 'Gray', 'VgaColor',
           'OLE_YSIZE_CONTAINER', 'OLE_TRISTATE', 'FONTSIZE', 'Color',
           'StdFont', 'OLE_ENABLEDEFAULTBOOL', 'IPicture',
